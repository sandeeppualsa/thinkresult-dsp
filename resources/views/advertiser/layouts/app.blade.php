        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu">
                <div class="app-brand demo">
                    <a href="{{ url('advertiser/dashboard') }}" class="app-brand-link">
                ...
                <ul class="menu-inner py-1">
                    <li class="menu-item">
                        <a href="{{ url('advertiser/dashboard') }}" class="menu-link">
                            <i class="icon-base ti tabler-dashboard me-2"></i>
                            <div data-i18n="Dashboard">My Campaigns</div>
                        </a>
                    </li>
                </ul>
            </aside>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item mt-0" href="javascript:void(0);">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-0">{{ session('advertiser')->firstname }} {{ session('advertiser')->lastname }}</h6>
                                                    <small class="text-body-secondary">{{ session('advertiser')->email }}</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <div class="d-grid px-2 pt-2 pb-1">
                                            <a class="btn btn-sm btn-danger d-flex" href="{{ url('advertiser/logout') }}">
